import { LoginScreen, HomeScreen, WidjetScreen, ProfilScreen, ProfilScreenSecond, ProfilScreenThird, RegisterScreen, CompagnyCode, ChosePlanScreen, PaymentScreen, TwitterPage, ConvPage, WeatherScreen } from './src/Screens'
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={{headerShown : false}}>
          ...
          <Stack.Screen name="Conv" component={ ConvPage } />
