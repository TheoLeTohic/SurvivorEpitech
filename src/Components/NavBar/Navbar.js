...
export default class Navbar extends Component {
    ...
    {this.props.index == 4 ? <Text style={styles.txtnavbar}>Widgets</Text> : null}
            ...
            <TouchableOpacity onPress={() => this.props.navigation.navigate("Profil")} style = {styles.navbaritem}>
            <Svg xmlns="http://www.w3.org/2000/Svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
    ...
    {this.props.index == 5 ? <Text style={styles.txtnavbar}>Profils</Text> : null}
            </TouchableOpacity>
          </View>
        );
    }
