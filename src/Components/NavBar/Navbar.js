...
export default class Navbar extends Component {
    render() {
        return (
            <View style = {styles.navbar}>
                <TouchableOpacity onPress={() => this.props.navigation.navigate("Home", {id: this.props.id, code: this.props.code})} style = {styles.navbaritem}>
    ...
    {this.props.index === 2 ? <Text style={styles.txtnavbar}>Home</Text> : null}
            ...
            <TouchableOpacity onPress={() => this.props.navigation.navigate("Admin", {id: this.props.id, code: this.props.code})} style = {[styles.navbaritem]}>
            <Svg width="25" height="24" viewBox="0 0 25 24" fill="none">
    ...
    {this.props.index === 3 ? <Text style={styles.txtnavbar}>Analitics</Text> : null}
            ...
            <TouchableOpacity onPress={() => this.props.navigation.navigate("Widjet", {id: this.props.id, code: this.props.code})} style = {styles.navbaritem}>
    ...
    {this.props.index === 4 ? <Text style={styles.txtnavbar}>Widgets</Text> : null}
            ...
            <TouchableOpacity onPress={() => this.props.navigation.navigate("Profile" , {id: this.props.id, code: this.props.code})} style = {styles.navbaritem}>
            <Svg width="25" height="24" viewBox="0 0 25 24" fill="none">
